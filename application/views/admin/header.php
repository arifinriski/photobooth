...
<body>
    ...
    <link href="<?=base_url();?>assets/admin/bootstrap/css/AdminLTE.min.css" rel="stylesheet">
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
 -->
    ...
    <style type="text/css">
     ...
     <!-- Custom Fonts -->
    <link href="<?=base_url();?>assets/admin/DataTables/datatables.min.css" rel="stylesheet" type="text/css">
